...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
      ...
      ..loadRequest(Uri.parse('https://hnbinfo.com/'));
...
//     final apiUrl = 'https://api.example.com/data';  // Replace with your API endpoint
//     try {
//       final response = await http.get(Uri.parse(apiUrl));

//       if (response.statusCode == 200) {
//         // Data fetched successfully, handle the response here
//         print('Data: ${response.body}');
//       } else {
//         // Handle other status codes (4xx, 5xx) as needed
//         print('Error: ${response.statusCode}');
//       }
//     } catch (e) {
//       // Handle network-related errors, such as timeouts or no internet connection
//       print('Error: $e');
//     }
//   }
// }
